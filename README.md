...
- A failed teleport will display an error message and play a sound. Teleports can fail from invalid syntax, invalid player selection, and trying to teleport when in Adventure mode.
- Refer to this video:  
