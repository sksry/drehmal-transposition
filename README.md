...
- You may teleport to a player by typing `Teleport` into the book and signing it **after titling the book with the username that you want to teleport to.** You can not teleport to players with names that are 16 characters long due to the title length limit. Refer to the question sections for more details.
