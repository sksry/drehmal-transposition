...
execute as @s[tag=book_noperms] run tellraw @a [{"text":"["},{"text":"ａｖＳＹＳ","color":"aqua"},{"text":"] ／／ＩＮＳＵＦＦＩＣＩＥＮＴ ＰＥＲＭＩＳＳＩＯＮＳ．／／","color":"white"}]
...
execute as @s[tag=book_player_teleport_fatal] run tellraw @a [{"text":"["},{"text":"ａｖＳＹＳ","color":"aqua"},{"text":"] ／／ＦＡＴＡＬ ＴＲＡＮＳＰＯＳＩＴＩＯＮ ＥＲＲＯＲ．／／","color":"white"}]
...
execute as @s[tag=book_player_teleport_failed] run tellraw @a [{"text":"["},{"text":"ａｖＳＹＳ","color":"aqua"},{"text":"] ／／ＬＩＮＫ ＳＥＡＲＣＨ ＦＡＩＬＥＤ．／／","color":"white"}]
...
execute as @s[tag=book_missed] run tellraw @a [{"text":"["},{"text":"ａｖＳＹＳ","color":"aqua"},{"text":"] ／／ＩＮＶＡＬＩＤ ＳＹＮＴＡＸ．／／","color":"white"}]
